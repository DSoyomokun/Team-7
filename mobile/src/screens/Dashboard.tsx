...
export default function Dashboard() {
  ...
  const handleAddTransaction = (transactionData: any) => {
    ...
    // Transaction was already created by the TransactionBottomSheet
    // Here you could refresh the dashboard data or update local state
    // For now, we'll just log it - later we can add real-time updates
  };
