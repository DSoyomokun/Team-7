...
describe('AccountService', () => {
  ...
  describe('ensureDefaultAccount', () => {
    it('should return existing account if user has accounts', async () => {
      ...
      const result = await AccountService.ensureDefaultAccount('user-123');
    ...
    it('should throw error if database query fails', async () => {
      ...
      await expect(AccountService.ensureDefaultAccount('user-123'))
  ...
  describe('updateBalanceForTransaction', () => {
    it('should update account balance for expense', async () => {
      ...
      await AccountService.updateBalanceForTransaction('acc-123', 200, true);
    ...
    it('should update account balance for income', async () => {
      ...
      await AccountService.updateBalanceForTransaction('acc-123', 300, false);
    ...
    it('should throw error if account not found', async () => {
      ...
      await expect(AccountService.updateBalanceForTransaction('acc-123', 200, true))
  ...
  describe('recalculateBalance', () => {
    it('should recalculate balance from all transactions', async () => {
      ...
      const balance = await AccountService.recalculateBalance('acc-123');
  ...
  describe('getAccountById', () => {
    it('should return account if found and belongs to user', async () => {
      ...
      const result = await AccountService.getAccountById('acc-123', 'user-123');
    ...
    it('should throw error if account not found', async () => {
      ...
      await expect(AccountService.getAccountById('acc-123', 'user-123'))
  ...
  describe('createAccount', () => {
    ...
    it('should throw error for invalid account data', async () => {
      ...
      await expect(AccountService.createAccount(invalidData))
