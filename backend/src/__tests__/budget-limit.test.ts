...
describe('BudgetLimit Model', () => {
  ...
  describe('Constructor', () => {
    it('should create a valid BudgetLimit instance', () => {
      const budgetLimit = new BudgetLimit(validProps);
    ...
    it('should handle string dates in constructor', () => {
      ...
      const budgetLimit = new BudgetLimit(propsWithStringDates);
    ...
    it('should throw error for missing user_id', () => {
      ...
      expect(() => new BudgetLimit(invalidProps)).toThrow('user_id is required');
    });

    it('should throw error for missing category_id', () => {
      const invalidProps = { ...validProps, category_id: '' };
      
      expect(() => new BudgetLimit(invalidProps)).toThrow('category_id is required');
    });

    it('should throw error for negative limit_amount', () => {
      const invalidProps = { ...validProps, limit_amount: -100 };
      
      expect(() => new BudgetLimit(invalidProps)).toThrow('limit_amount must be a non-negative number');
    });

    it('should throw error for invalid period', () => {
      const invalidProps = { ...validProps, period: 'invalid' as any };
      
      expect(() => new BudgetLimit(invalidProps)).toThrow('period must be one of: weekly, monthly, yearly');
    });
    ...
    it('should throw error when end_date is before start_date', () => {
      ...
      expect(() => new BudgetLimit(invalidProps)).toThrow('end_date must be after start_date');
    });
    ...
    it('should throw error for invalid dates', () => {
      ...
      expect(() => new BudgetLimit(invalidProps)).toThrow('start_date must be a valid date');
    });
  });
  ...
  describe('toJSON', () => {
    ...
    it('should include id when provided', () => {
      ...
      const budgetLimit = new BudgetLimit(propsWithId);
      const json = budgetLimit.toJSON();
  ...
  describe('calculateSpendingPercentage', () => {
    it('should calculate correct percentage', () => {
      const budgetLimit = new BudgetLimit({ ...validProps, limit_amount: 1000 });
    ...
    it('should handle zero limit', () => {
      const budgetLimit = new BudgetLimit({ ...validProps, limit_amount: 0 });
  ...
  describe('generatePeriodDates', () => {
    ...
    it('should generate weekly period dates', () => {
      const { start_date, end_date } = BudgetLimit.generatePeriodDates('weekly', baseDate);
    ...
    it('should generate monthly period dates', () => {
      const { start_date, end_date } = BudgetLimit.generatePeriodDates('monthly', baseDate);
    ...
    it('should generate yearly period dates', () => {
      const { start_date, end_date } = BudgetLimit.generatePeriodDates('yearly', baseDate);
    ...
    it('should use current date when no base date provided', () => {
      const now = new Date();
      const { start_date, end_date } = BudgetLimit.generatePeriodDates('monthly');
  ...
  describe('validate static method', () => {
    it('should return valid for correct props', () => {
      const result = BudgetLimit.validate(validProps);
    ...
    it('should return invalid for incorrect props', () => {
      ...
      const result = BudgetLimit.validate(invalidProps);
