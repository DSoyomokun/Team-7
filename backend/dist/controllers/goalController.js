...
const goalController = {
    ...
    createGoal: async (req, res) => {
        try {
            ...
            const goal = await goal_service_1.GoalService.createGoal(user_id, goalData);
            res.status(201).json({
                success: true,
    ...
    getGoals: async (req, res) => {
        try {
            ...
            const goals = await goal_service_1.GoalService.getGoals(user_id, filters);
            res.status(200).json({
                success: true,
    ...
    getGoalById: async (req, res) => {
        try {
            ...
            const goal = await goal_service_1.GoalService.getGoalById(id, user_id);
            res.status(200).json({
                success: true,
                data: goal.toJSON()
            });
    ...
    updateGoal: async (req, res) => {
        try {
            ...
            const goal = await goal_service_1.GoalService.updateGoal(id, user_id, updates);
            res.status(200).json({
                success: true,
    ...
    updateProgress: async (req, res) => {
        try {
            ...
            const goal = await goal_service_1.GoalService.updateGoalProgress(id, user_id, current_amount);
            res.status(200).json({
                success: true,
    ...
    markCompleted: async (req, res) => {
        try {
            ...
            const goal = await goal_service_1.GoalService.markGoalCompleted(id, user_id);
            res.status(200).json({
                success: true,
    ...
    deleteGoal: async (req, res) => {
        try {
            ...
            await goal_service_1.GoalService.deleteGoal(id, user_id);
            res.status(200).json({
                success: true,
    ...
    getAnalytics: async (req, res) => {
        try {
            ...
            const analytics = await goal_service_1.GoalService.getGoalAnalytics(user_id);
            res.status(200).json({
                success: true,
                data: analytics
            });
    ...
    getRecommendations: async (req, res) => {
        try {
            ...
            const recommendations = await goal_service_1.GoalService.getGoalRecommendations(user_id);
            res.status(200).json({
                success: true,
    ...
    syncProgressFromTransactions: async (req, res) => {
        try {
            const user_id = req.user?.id;
            ...
            const updatedGoals = await goal_service_1.GoalService.updateGoalProgressFromTransactions(user_id, goal_id);
            res.status(200).json({
                success: true,
