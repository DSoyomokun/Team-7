...
describe('Budget Controller Integration Tests', () => {
    ...
    describe('GET /api/budget/analysis', () => {
        ...
        it('should return budget analysis successfully', async () => {
            budget_service_1.budgetService.getBudgetAnalysis.mockResolvedValue(mockAnalysis);
            ...
            expect(budget_service_1.budgetService.getBudgetAnalysis).toHaveBeenCalledWith(mockUserId, 'month', 2024);
        });
        it('should use default parameters when not provided', async () => {
            ...
            const response = await (0, supertest_1.default)(app)
                ...
                .set('Authorization', mockAuthToken);
            expect(response.status).toBe(200);
            expect(budget_service_1.budgetService.getBudgetAnalysis).toHaveBeenCalledWith(mockUserId, 'month', undefined);
        });
        ...
        it('should handle service errors', async () => {
            budget_service_1.budgetService.getBudgetAnalysis.mockRejectedValue(new Error('Database connection failed'));
            const response = await (0, supertest_1.default)(app)
                .get('/api/budget/analysis')
                .set('Authorization', mockAuthToken);
    ...
    describe('GET /api/budget/trends', () => {
        ...
        it('should return budget trends successfully', async () => {
            budget_service_1.budgetService.getBudgetTrends.mockResolvedValue(mockTrends);
            const response = await (0, supertest_1.default)(app)
            ...
            expect(budget_service_1.budgetService.getBudgetTrends).toHaveBeenCalledWith(mockUserId, 'month', 12);
        });
        it('should use default parameters', async () => {
            ...
            const response = await (0, supertest_1.default)(app)
                ...
                .set('Authorization', mockAuthToken);
            expect(response.status).toBe(200);
            expect(budget_service_1.budgetService.getBudgetTrends).toHaveBeenCalledWith(mockUserId, 'month', 6);
        });
    });
    describe('GET /api/budget/categories', () => {
        ...
        it('should return category breakdown successfully', async () => {
            budget_service_1.budgetService.getCategoryBreakdown.mockResolvedValue(mockCategories);
            const response = await (0, supertest_1.default)(app)
            ...
            expect(budget_service_1.budgetService.getCategoryBreakdown).toHaveBeenCalledWith(mockUserId, 'week');
        });
    });
    describe('POST /api/budget/limits', () => {
        ...
        it('should create budget limit successfully', async () => {
            ...
            budget_service_1.budgetService.createBudgetLimit.mockResolvedValue(mockLimit);
            const requestBody = {
                category_id: 'cat-1',
                limit_amount: 500,
                period: 'monthly'
            ...
            expect(budget_service_1.budgetService.createBudgetLimit).toHaveBeenCalledWith(mockUserId, 'cat-1', 500, 'monthly');
        });
    ...
    describe('GET /api/budget/limits', () => {
        ...
        it('should return all budget limits for user', async () => {
            budget_service_1.budgetService.getBudgetLimits.mockResolvedValue(mockLimits);
            const response = await (0, supertest_1.default)(app)
            ...
            expect(budget_service_1.budgetService.getBudgetLimits).toHaveBeenCalledWith(mockUserId);
        });
    });
    describe('PUT /api/budget/limits/:id', () => {
        ...
        it('should update budget limit successfully', async () => {
            budget_service_1.budgetService.updateBudgetLimit.mockResolvedValue(mockUpdatedLimit);
            const response = await (0, supertest_1.default)(app)
            ...
            expect(budget_service_1.budgetService.updateBudgetLimit).toHaveBeenCalledWith(limitId, 750, undefined);
        });
    ...
    describe('DELETE /api/budget/limits/:id', () => {
        ...
        it('should delete budget limit successfully', async () => {
            budget_service_1.budgetService.deleteBudgetLimit.mockResolvedValue(undefined);
            const response = await (0, supertest_1.default)(app)
            ...
            expect(budget_service_1.budgetService.deleteBudgetLimit).toHaveBeenCalledWith(limitId);
        });
    ...
    describe('GET /api/budget/warnings', () => {
        ...
        it('should return budget warnings successfully', async () => {
            budget_service_1.budgetService.getBudgetWarnings.mockResolvedValue(mockWarnings);
            const response = await (0, supertest_1.default)(app)
            ...
            expect(budget_service_1.budgetService.getBudgetWarnings).toHaveBeenCalledWith(mockUserId);
        });
    });
    describe('GET /api/budget/export', () => {
        ...
        it('should export budget report in JSON format', async () => {
            budget_service_1.budgetService.exportBudgetReport.mockResolvedValue(mockExportData);
            const response = await (0, supertest_1.default)(app)
            ...
            expect(budget_service_1.budgetService.exportBudgetReport).toHaveBeenCalledWith(mockUserId, 'spending', 'month', 'json');
        });
        it('should export budget report in CSV format', async () => {
            ...
            budget_service_1.budgetService.exportBudgetReport.mockResolvedValue(csvExportData);
            const response = await (0, supertest_1.default)(app)
                .get('/api/budget/export')
                .set('Authorization', mockAuthToken)
...
//# sourceMappingURL=budget-controller.test.js.map