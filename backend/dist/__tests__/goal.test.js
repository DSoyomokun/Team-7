...
describe('Goal Model Tests', () => {
    ...
    describe('Goal Date Methods', () => {
        test('should detect overdue goals', () => {
            ...
            const overdueGoal = new Goal_1.Goal({
                user_id: 'user-123',
                name: 'Overdue Goal',
                type: 'savings',
                target_amount: 1000,
    ...
    describe('Goal Validation', () => {
        test('should validate valid goal data', () => {
            ...
            const validation = Goal_1.Goal.validate(validData);
        ...
        test('should catch validation errors', () => {
            ...
            const validation = Goal_1.Goal.validate(invalidData);
    ...
    describe('Goal Helper Methods', () => {
        ...
        test('should create goal templates', () => {
            const templates = Goal_1.Goal.createGoalTemplates();
        ...
        test('should calculate daily savings needed', () => {
            ...
            const dailySavings = Goal_1.Goal.calculateDailySavingsNeeded(1000, futureDate);
