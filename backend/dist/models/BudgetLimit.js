...
exports.BudgetLimit = void 0;
class BudgetLimit {
    constructor({ id, user_id, category_id, limit_amount, period, start_date, end_date, created_at, updated_at }) {
        // Validation
        if (!user_id)
        ...
        if (limit_amount === undefined || limit_amount === null)
            throw new Error('limit_amount is required');
    ...
    calculateSpendingPercentage(spentAmount) {
    ...
    static generatePeriodDates(period, baseDate = new Date()) {
...
//# sourceMappingURL=BudgetLimit.js.map